            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-collapse">
                    <ul class="navbar-nav mr-auto mt-md-0">
                     ...
                     <li class="nav-item mt-3">Learn Development With Milton(Admin Panel)</li>
					</ul>
            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                    	...
                    	<li> <a href="{{url('/course')}}" ><span> <i class="fas fa-globe"></i> </span><span class="hide-menu">Courses</span></a></li>
                        <li> <a href="{{url('/democlass')}}" ><span> <i class="fas fa-book-open"></i> </span><span class="hide-menu">Demo Class</span></a></li>
                        <li> <a href="{{url('/classroom')}}" ><span> <i class="fas fa-book"></i> </span><span class="hide-menu">Tutorials</span></a></li>
					</ul>
                </nav>
            </div>
        </aside>
